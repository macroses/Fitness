...
<template>
  <form class="account__user-form" @submit.prevent="handleSubmit">
    ...
    <Input v-model="userData.username" :value="userData.username" label-placeholder="Name" />
    <Input
    ...
    />
    <GroupInputs>
      <Radio v-model="userData.gender" label="Male" name="gender" value="Male" />
      <Radio v-model="userData.gender" label="Female" name="gender" value="Female" />
    </GroupInputs>
    <GroupInputs>
      <Radio v-model="userData.level" label="Novice" name="gender" value="Novice" />
      <Radio v-model="userData.level" label="Advanced" name="gender" value="Advanced" />
      <Radio v-model="userData.level" label="Professional" name="gender" value="Professional" />
    </GroupInputs>
    <Button class="account__user-form-submit" type="submit"> Update info</Button>
  </form>
</template>
